...
public class ClubScheduleSubmitActivity extends AppCompatActivity {
            ...
            public void onClick(View v) {
                ...
                ClubAPI.getInstance().getClubByKey(user.getManagingClubId(), getApplicationContext(), new AfterQueryListener() {
                    ...
                    public void afterQuery(DataSnapshot dataSnapshot) {
                        ...
                        ClubSchedule clubSchedule = new ClubSchedule(title, startDate, endDate, club.getKey());
                        ClubScheduleAPI.getInstance().registerClubSchedule(clubSchedule);
