...
/**
 * Created by uhn61 on 2017-11-20.
 */

public class ClubActPicAdapter extends ArrayAdapter<ClubActivity> {
    private List<ClubActivity> clubActivities = new ArrayList<>();
    private Handler handler = new Handler();

    public ClubActPicAdapter(Context context, ArrayList<ClubActivity> clubActivities) {
